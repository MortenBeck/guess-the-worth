...
import { Box, VStack, HStack, Text, Alert, AlertTitle, AlertDescription } from "@chakra-ui/react";
// Simple custom icons
...
const NotificationSystem = () => {
  ...
  return (
    <Box position="fixed" top="80px" right="4" zIndex={2000} maxW="400px" w="full">
        ...
        {notifications.map((notification) => (
          ...
          >
            ...
            <Box flex="1">
              ...
              <AlertDescription fontSize="xs">{notification.message}</AlertDescription>
            </Box>
