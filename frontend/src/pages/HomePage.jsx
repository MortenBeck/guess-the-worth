...
const HomePage = () => {
  ...
  return (
    <Box bg="#0f172a" color="white" minH="100vh">
      {/* Hero Section */}
      <Box pt="6rem" pb="8rem" position="relative" overflow="hidden">
        {/* Background Gradient */}
        <Box
          position="absolute"
          top="0"
            ...
            <SimpleGrid columns={{ base: 1, md: 3 }} spacing={{ base: 32, md: 64 }}>
              ...
              >
                <VStack spacing={8}>
                  ...
                  <Text color="#94a3b8" lineHeight="1.6">
                    Discover unique artworks from talented artists. Each piece has a secret minimum
              ...
              >
                <VStack spacing={8}>
                  ...
                  <Text color="#94a3b8" lineHeight="1.6">
                    Bid what you think the artwork is worth. You won't know the secret threshold
                    until you hit it!
                  </Text>
                </VStack>
              </Box>
              ...
              >
                <VStack spacing={8}>
                  ...
                  <Text color="#94a3b8" lineHeight="1.6">
                    When your bid meets or exceeds the secret threshold, you instantly win and
            ...
            <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={16} alignItems="center">
              <VStack align="start" spacing={8}>
                <Text fontSize="lg" color="#94a3b8" lineHeight="1.8">
                  Guess The Worth revolutionizes art auctions by introducing the thrill of secret
                  threshold bidding. Unlike traditional auctions where you compete against others,
                  here you're guessing the artist's true valuation of their work.
                </Text>

                <Text fontSize="lg" color="#94a3b8" lineHeight="1.8">
                  Artists set a hidden minimum price they're willing to accept. When your bid meets
                  or exceeds this secret threshold, you instantly win the artwork - no waiting, no
                  outbidding, just pure intuition and art appreciation.
                </Text>
                ...
                <VStack align="start" spacing={4}>
                  <HStack spacing={3}>
                    ...
                    <Text color="white" fontWeight="500">
                      Instant wins when you hit the secret threshold
                    </Text>
                  </HStack>
                  <HStack spacing={3}>
                    <Box w="6px" h="6px" bg="blue.400" borderRadius="full" />
                    <Text color="white" fontWeight="500">
                      No bidding wars or auction stress
                    </Text>
                  </HStack>
                  <HStack spacing={3}>
                    <Box w="6px" h="6px" bg="blue.400" borderRadius="full" />
                    <Text color="white" fontWeight="500">
                      Direct support to artists at fair prices
                    </Text>
                  </HStack>
                  <HStack spacing={3}>
                    <Box w="6px" h="6px" bg="blue.400" borderRadius="full" />
                    <Text color="white" fontWeight="500">
                      Discover emerging and established artists
                    </Text>
                  </HStack>
                </VStack>
              </VStack>
              ...
              >
                <VStack spacing={8}>
                  <Text fontSize="4xl" fontWeight="bold" color="#ec4899">
                    🎨
                  </Text>
                  <VStack spacing={6}>
                    ...
                    <Text color="#94a3b8" textAlign="center" lineHeight="1.6">
                      This platform demonstrates modern web development practices, containerization,
                      and deployment strategies as part of our DevOps learning journey.
                    </Text>
                  </VStack>
                </VStack>
              </Box>
          ...
          <VStack spacing={12} textAlign="center">
            <VStack spacing={8}>
              ...
              <Text color="#94a3b8" maxW="500px" fontSize="lg" lineHeight="1.6">
                Join our community of art enthusiasts and discover your next favorite piece. Sign up
                now and get access to exclusive artworks.
              </Text>
            </VStack>
      ...
      <Box bg="#0f172a" py={16} borderTop="1px solid" borderColor="rgba(255,255,255,0.1)">
        <Container maxW="7xl">
          <Text textAlign="center" color="#94a3b8" fontSize="sm">
            © 2024 {config.APP_NAME || "Guess The Worth"}. Built for DTU DevOps Course. All rights
            reserved.
          </Text>
        </Container>
      </Box>
