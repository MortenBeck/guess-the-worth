      ...
      <Container maxW="container.md" py={8}>
        <VStack spacing={8} align="stretch">
          <Box>
            ...
            <Text color="#94a3b8">
              Set your secret threshold and list your artwork for auction
            </Text>
          </Box>
          ...
          <Box bg="#1e293b" p={6} borderRadius="lg" boxShadow="sm" border="1px" borderColor="rgba(255,255,255,0.1)">
            <VStack spacing={6}>
              ...
              <Box w="full">
                <Text fontWeight="bold" mb={2} color="white">Secret Threshold ($) *</Text>
                <Text fontSize="sm" color="#94a3b8" mb={2}>
                  This is your hidden buyout price. When a bid reaches this amount, the artwork sells instantly.
                </Text>
                <input
                  style={{
                    width: '100%',
              ...
              <Box display="grid" gridTemplateColumns="repeat(2, 1fr)" gap={4} w="full">
                <Box>
                  <Text fontWeight="bold" mb={2} color="white">Category</Text>
                  <input
                    style={{
                      width: '100%',
                      padding: '12px',
                ...
                <Box>
                  <Text fontWeight="bold" mb={2} color="white">Medium</Text>
                  <input
                    style={{
                      width: '100%',
                      padding: '12px',
              ...
              <Box display="grid" gridTemplateColumns="repeat(2, 1fr)" gap={4} w="full">
                <Box>
                  <Text fontWeight="bold" mb={2} color="white">Dimensions</Text>
                  <input
                    style={{
                      width: '100%',
                      padding: '12px',
                ...
                <Box>
                  <Text fontWeight="bold" mb={2} color="white">Year Created</Text>
                  <input
                    style={{
                      width: '100%',
                      padding: '12px',
              ...
              <Box w="full">
                <Text fontWeight="bold" mb={2} color="white">Upload Image</Text>
                <input
                  type="file"
                  accept="image/*"
                  style={{
